...
+ (void)load
{
    ...
    for(int i = 0; i < 1000; i++) {
        NSString *path = [NSString stringWithFormat:@"%@/assets/src/autogenerated/images_dir/%04d.jpg", [[NSBundle mainBundle] bundlePath], i];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.image = _images[[dataItem[@"index"] intValue]];
