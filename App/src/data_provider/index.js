...
export default class DataProvider {
  constructor() {
    ...
    const images_prefix = NativeModules.NativeInfo.imagesPath;

    this._data = _.times(1000, function(i) {
      return {
        index: i,
        name: firsts[i % firsts.length] + ' ' + lasts[i % lasts.length],
        img_path: images_prefix + images[i % images.length]
      }
    })
  }
